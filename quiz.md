...
1. 2進数 10111 を3倍した2進数
1. 16進数「AA」を10進数に変換
1. 8ビット = ( )バイト

## 11/24

1. ネットワークで使用されるNASとは何ですか
1. クライアントサーバシステムのシンクライアントとは何ですか
1. システムの経済性におけて、TCOとは何ですか
1. デバイスドライバの役割は何ですか
1. バックアップにおいて、フルバックアップと差分バックアップの  
違いを説明してください

## 11/29

1. データベースモデルのリレーショナル型データベースを  
説明してください
1. データベース管理システム(DBMS)とは何ですか
1. リレーショナルデータベースにおけるテーブルの役割を  
説明してください
1. 上記テーブルの主キーの役割を説明してください
1. 上記テーブルの外部キーの役割を説明してください